...
async function initGL() {
    ...
    panelMesh = createCurvedQuadMesh(CURVE_SEGMENTS, CURVE_DEPTH_RATIO);
    indexCount = panelMesh.indices.length;

    // POSITION BUFFER
    positionBuffer = gl.createBuffer();
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    gl.bufferData(gl.ARRAY_BUFFER, panelMesh.positions, gl.STATIC_DRAW);
    ...
    gl.bufferData(gl.ARRAY_BUFFER, panelMesh.uvs, gl.STATIC_DRAW);
    ...
    gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, panelMesh.indices, gl.STATIC_DRAW);
